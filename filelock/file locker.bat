...
echo 4) Submit feedback with template
echo 5) Submit feedback
set/p "cho=choose>"
if %cho%==1 goto openfolder
if %cho%==2 goto changepass
if %cho%==3 goto LOCK
if %cho%==4 start https://github.com/trey7658/File-lock/issues/new/choose
if %cho%==5 start https://github.com/trey7658/File-lock/issues/new
echo Invalid choice.
goto Unlocked
:openfolder
@echo off
